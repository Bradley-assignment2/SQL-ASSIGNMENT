...
#This query will populate the students table, since the StudentID is set to auto increment,
#manually creating them is not neccesary
/*
...
#This query will populate the Courses table, 
#unlike StudentID, CourseID is a varchar, and will be added manually.
#"MAT109" also had two different entities in the sample (PT, FT),
#so i made a new one called "MAT110".
/*
insert into Courses
