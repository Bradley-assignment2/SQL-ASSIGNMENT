...
update Enrollments 
join Courses  on Courses.CourseID = Courses.CourseID
set Enrollments.EndDate = date_add(Enrollments.StartDate, interval Courses.CourseDuration month)
where Enrollments.EndDate is null
and Enrollments.FinalGrade is not null;